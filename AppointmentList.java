...
public class AppointmentList {
    ...
    public void createAppointment(LocalDateTime dateTime, int numcycles, Resident resident){
        ...
        Appointment appointment = new Appointment(null, numcycles, numcycles, numcycles, numcycles, numcycles, numcycles, resident);
    ...
    public static void createAppointment(LocalDateTime dateTime, int numcycles, int idnum){
        //LocalDateTime dateTime = LocalDateTime.of(year, month, day, hour, minute);
        Appointment appointment = new Appointment(null, idnum, idnum, idnum, idnum, idnum, idnum, null);
        appointmentList.add(appointment);
    }
