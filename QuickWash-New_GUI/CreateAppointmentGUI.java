...
public class CreateAppointmentGUI extends JFrame {
    ...
    private class ScheduleBtnListener implements ActionListener
    {
        public void actionPerformed(ActionEvent e)
        {
            ...
            int monthInt=(int) monthValue.charAt(0);
            ...
            createAppointment(name,washValueInt,dryValueInt,yearInt,monthInt,dayValueInt,hourInt);
            thisRGUI = new ResidentGUI(thisAddGUI);
        }
    ...
    public void createAppointmentAppointment (String name,int washCycles,int dryCycles,int year,int month,int day,int hour){
