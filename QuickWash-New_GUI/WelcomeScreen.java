...
public class WelcomeScreen extends JFrame {
    ...
    private class LoginBtnListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if(db.selectUserById(Integer.parseInt(txtName))!=null){
                ...
                if(txtPass.equals(dbPassword)){
                    ...
                    //If password is correct, open resident gui screen
                    resGUI = new ResidentGUI(thisUserData,txtName,dbName);
                }else{
                    JOptionPane.showMessageDialog(null, "Error: Incorrect password. Try Again", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }else{
                System.out.println("Line 288");
                JOptionPane.showMessageDialog(null, "Error: Could not find ID Number. Try Again", "Error", JOptionPane.ERROR_MESSAGE);
            }
