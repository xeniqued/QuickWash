...
public class ResidentGUI extends JFrame {
    ...
    public ResidentGUI(WelcomeScreen ws,String idString,String name) {
        ...
        //Appointment aList=tableData("AppointmentDatabase.txt");//load appointments
        ...
        //Getting table var in table render
        JTable appointmentTable=apptTable.getTable();

        appointmentTable.getSelectionModel().addListSelectionListener(e -> {
            this.selectedRowInt = appointmentTable.getSelectedRow();
        ...
        selectedData.add(selectedRowInt);


        //Rendering details table with data above
        detsTable = new TableRenderer(detsinner2Pnl, new Dimension(826, 35), detsColumnNames, selectedData);
    ...
    public static String getWeekdayAsString(int day, int month, int year) {
        LocalDate date = LocalDate.of(year, month, day);
        DayOfWeek dayOfWeek = date.getDayOfWeek();
        return dayOfWeek.toString();
    }

    public String[] processSelectedRow(Vector<?> rowData) {
        
        // Process selected row data here
        System.out.println("Selected Row Data in ResidentGUI: " + rowData);
        // Extract date and time from the selected row
        String dateStr = (String) rowData.get(0); // Assuming date is at index 2
        String timeStr = (String) rowData.get(1); // Assuming time is at index 3
        ...
        String[] selectedRowList={timeStr,weekday,monthName,dayString,yearString};
