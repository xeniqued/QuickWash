...
public class WelcomeScreen2 extends JFrame {
    ...
    private static WelcomeScreen2 thisUserData; //current screen instance
    ...
    public WelcomeScreen2() {    
        ...
        innerPnl.setLayout(new GridLayout(4, 1, 20, 15));
        ...
        forgotbtn.setForeground(mainWhite);
        forgotbtn.setBorderPainted(false);
        forgotbtn.setContentAreaFilled(false);
        forgotbtn.setFocusPainted(false);
        forgotbtn.addActionListener(new forgotbtnListener());

        innerPnl.add(forgotbtn);
    ...
    public static void main(String[] args) {      
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                thisUserData = new WelcomeScreen2();
            }
        });
   ...
   private class forgotbtnListener implements ActionListener{
    public void actionPerformed(ActionEvent e){
        setVisible(false);
        ForgotPasswordGUI  thisfp = new ForgotPasswordGUI(thisUserData);
        thisfp.setVisible(true);
